...
//       {post.repostedBy && (
//         <div className="px-4 pt-3 text-xs text-faint flex items-center gap-1.5">
//           <Repeat2 size={13} /> Reposted by {post.repostedBy}
//         </div>
//       )}
...
//           <img
//             src={mediaUrl(post.author.avatar) || `https://api.dicebear.com/7.x/avataaars/svg?seed=${post.author.username}`}
//             className="w-10 h-10 rounded-full object-cover"
//             alt=""
//           />
//           <div>
//             <p className="text-sm font-semibold leading-tight">{post.author.username}</p>
//             <p className="text-xs text-faint">{post.location || "Somewhere"}</p>
//           </div>
//         </Link>
//         <div className="relative">
//           <button
...
//         <div className="w-full bg-black/5">
//           {post.mediaType === "video" ? (
//             <video src={mediaUrl(post.mediaUrl)} controls className="w-full max-h-[520px] object-cover" />
//           ) : (
//             <img src={mediaUrl(post.mediaUrl)} className="w-full max-h-[520px] object-cover" alt="" />
//           )}
//         </div>
//       )}
...
//           <Heart
//             size={21}
//             className={liked ? "fill-brand-pink text-brand-pink" : "group-hover:text-brand-pink transition"}
//           />
//           <span className="text-sm">{likeCount.toLocaleString()} Like</span>
//         </button>
//         <button onClick={() => setShowComments(true)} className="flex items-center gap-1.5 group">
//           <MessageCircle size={21} className="group-hover:text-brand-purple transition" />
//           <span className="text-sm">{post.commentCount} Comment</span>
//         </button>
//         <button onClick={toggleRepost} className="flex items-center gap-1.5 group">
//           <Repeat2
//             size={21}
//             className={reposted ? "text-green-500" : "group-hover:text-green-500 transition"}
//           />
//           <span className="text-sm">{repostCount} Repost</span>
//         </button>
//         <button onClick={toggleSave} className="flex items-center gap-1.5 ml-auto group">
//           <Bookmark
//             size={20}
//             className={saved ? "fill-brand-purple text-brand-purple" : "group-hover:text-brand-purple transition"}
//           />
//           <span className="text-sm">{saved ? "Saved" : "Save"}</span>
//         </button>
//       </div>
...
//       {showComments && (
//         <CommentsDrawer post={post} onClose={() => setShowComments(false)} onChange={onChange} />
//       )}
//     </div>
//   );
// }
